...
class BackYoga extends StatelessWidget {
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("assets/images/back-yoga.jpg"),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        width: size.width * .6,
                        child: Text(
                          "Back bend yoga helps to improve your posture, open up the shoulders and chest & stretch the hip flexors.",
                          style: contextStyle,
                        ),
                      ),
                      SizedBox(
